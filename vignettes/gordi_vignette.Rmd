...
```{r}
# Nevim, proc tahle svina zas nefunguje

# obj |> 
#   gordi_plot() +
#   theme_dark() +
#   labs(title = 'This is a very nice plot',
#        subtitle = 'Do not try to argue with the authors, it is a nicely elaborated plot') +
#   theme(legend.position = 'bottom',
#         plot.title = element_text(colour = 'red'),
#         plot.subtitle = element_text(face = 'italic'),
#         axis.title = element_text(family = 'serif', colour = 'lightblue4')) 
```
